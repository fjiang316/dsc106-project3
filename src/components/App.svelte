<script>
  ...
  //US map
	...
	$: {
		...
		if (showFrench) selectedM.push('Many US cities sharing names with French-speaking countries are located in the East, especially in states near Canada, extending into the Midwest where French colonies once were. Canada, part of it were once a French colony known as New France, has the most cities with identical names. The close geographical proximity and historical ties can also be reason to the pattern.');
		...
		if (showItalian) selectedM.push('As we can observe, the majority of cities that share their names with Italian-speaking countries are located in the east of US. The city name Florance and country Italy appeared the most in the graph. The influx of Italian immigrats at the end of 19th century and the begining of 20th century can be one of the many reasons to this pattern.');
