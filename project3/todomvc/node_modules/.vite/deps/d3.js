...
function transformer2() {
  ...
  scale2.domain = function(_) {
    return arguments.length ? ([x0, x1] = _, t02 = transform2(x0 = +x0), t12 = transform2(x1 = +x1), k10 = t02 === t12 ? 0 : 1 / (t12 - t02), scale2) : [x0, x1];
  };
  scale2.clamp = function(_) {
...
function transformer3() {
  var x0 = 0, x1 = 0.5, x22 = 1, s2 = 1, t02, t12, t2, k10, k21, interpolator = identity2, transform2, clamp = false, unknown;
  function scale2(x4) {
  ...
  scale2.domain = function(_) {
    return arguments.length ? ([x0, x1, x22] = _, t02 = transform2(x0 = +x0), t12 = transform2(x1 = +x1), t2 = transform2(x22 = +x22), k10 = t02 === t12 ? 0 : 0.5 / (t12 - t02), k21 = t12 === t2 ? 0 : 0.5 / (t2 - t12), s2 = t12 < t02 ? -1 : 1, scale2) : [x0, x1, x22];
  };
  scale2.clamp = function(_) {
    return arguments.length ? (clamp = !!_, scale2) : clamp;
  };
...
function arc_default() {
  ...
  function arc() {
    ...
    if (!(r1 > epsilon6))
      ...
      var a01 = a0, a11 = a1, a00 = a0, a10 = a1, da0 = da2, da1 = da2, ap = padAngle.apply(this, arguments) / 2, rp = ap > epsilon6 && (padRadius ? +padRadius.apply(this, arguments) : sqrt2(r0 * r0 + r1 * r1)), rc = min3(abs3(r1 - r0) / 2, +cornerRadius.apply(this, arguments)), rc0 = rc, rc1 = rc, t02, t12;
      if (rp > epsilon6) {
...
function pie_default() {
  var value = identity_default4, sortValues = descending_default, sort2 = null, startAngle = constant_default6(0), endAngle = constant_default6(tau4), padAngle = constant_default6(0);
  function pie(data) {
